<aside>
	...
	<div class="mb-6">
		...
		<div>
			...
			<a href="{{ route('account.twoFactor.index') }}" class="block p-4 rounded no-underline font-bold border-r-4 border-transparent {{ return_if_else(on_page('account/twoFactor'), 'text-indigo-darker bg-indigo-lightest border-indigo', 'text-grey-darker hover:border-indigo hover:bg-indigo-lightest') }}">Two Factor Authentication</a>
